...
/** 
 * Si uso las comas en 300k da fallo y si le pones un punto no coge los de 300000 de ahi el formato de ese numero
 * cambiamos de lista a Track
 */
select "Name" ,
       "Milliseconds" as "Track_Title"
from "Track"
...
/** 
 * Uso Brazil porque es como esta escrito en la BD si pusiera brasil no habrian coincidencias
 * ademas cambio a custumer
 */
...
/** 
 * He intentado que busque espacio vacio antes y despues con una sencilla funcion or pero no consigo que me de los que solo contienen Music
*/
...
/**
 * Al no pedirme que imprima tambien el puesto hay que confiar en el codigo , si se necesita
 * en el selec se añadira un "Title" para poder confirmarlo
 */
select "FirstName" as "First_Name",
        "LastName" as "Last_name"
from "Employee" 
...
/**
 * la conversion de 5 min a milisegundos es de 300k de milisegundos
 */
...
/**
 * En este caso el codigo considero correcto pero en la base de datos no exite tal empleado
 */
select "FirstName" ,
       "LastName" 
from "Employee" 
where "City" = 'Seattle'
and   "State"= 'WA';
-- Ejercicio 12: Encuentra los clientes que están en el país 'USA' y tienen asignado un representante de soporte con un ID mayor o igual a 5.
-- Muestra el nombre del cliente y su ID de soporte.
...
-- Ejercicio 14: Lista las pistas que tienen una duración mayor a 250,000 milisegundos y pertenecen a un tipo de medio con ID 1 o 2. 
--Muestra el nombre de la pista y el tipo de medio.

select "Name" ,
        "MediaTypeId" 
from "Track" 
where "Milliseconds" > 250000 
and "MediaTypeId" between 1 and 2 ;
